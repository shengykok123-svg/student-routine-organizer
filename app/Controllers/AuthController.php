...
/** Handles registration, login, logout, and remembered sessions. */
final class AuthController extends Controller
{
    ...
    public function register(): void
    {
        ...
        if ($name === "" || mb_strlen($name) > 100) {
            ...
            Flash::add("error", "Enter a valid email address.");
            ...
            $this->notifications->create(
                ...
                "success",
                "Welcome to SRO",
                "Your account is ready. Start by setting up your routine.",
                "dashboard",
            );
            Flash::add("success", "Account created. You can now sign in.");
            $this->redirect("login");
        }
