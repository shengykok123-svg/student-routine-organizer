...
<section class="page-heading">
    <div>
        <p class="page-eyebrow">Account</p>
            <h1>Profile</h1>
                <p class="page-subtitle">Manage your identity, contact details, and profile picture.</p>
                </div>
            </section>
                        ...
                        <div class="col-12">
                            <div class="profile-picture-editor">
                                <div class="profile-picture-preview">
                                    ...
                                    <img src="<?= View::e(
                                        $baseUrl,
                                    ) ?>/profile/photo" alt="Current profile picture">
                                    <?php else: ?>
                                    <span>
                                        <?= View::e($initial) ?>
                                    </span>
                                ...
                                <div>
                                    <h2>Profile Picture</h2>
                                        <p class="text-muted mb-2">Upload a photo to show it in the top-right account menu.</p>
                                            <label class="form-label" for="profile_image">Choose picture</label>
                                                ...
                                                <div class="form-text">JPG, PNG, or WebP. Maximum 5 MB.</div>
                                                    ...
                                                    <div class="form-check mt-2">
                                                        <input class="form-check-input" id="remove_profile_image" type="checkbox" name="remove_profile_image">
                                            ...
                                            <div class="col-12">
                                                <label class="form-label" for="full_name">Full Name</label>
                                                    <input class="form-control" id="full_name" name="full_name" maxlength="100" value="<?= View::e(
                                                        $user["full_name"] ??
                                                            "",
