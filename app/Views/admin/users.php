...
<section class="content-card p-0 overflow-hidden">
    ...
    <form class="row g-2 px-3 pb-3" method="get">
        ...
        <div class="col-md-2"><select class="form-select" name="role"><option value="">All roles</option><option value="Student" <?= $filters["role"] === "Student" ? "selected" : "" ?>>Students</option><option value="Admin" <?= $filters["role"] === "Admin" ? "selected" : "" ?>>Administrators</option><option value="Super Admin" <?= $filters["role"] === "Super Admin" ? "selected" : "" ?>>Super Admins</option></select></div>
    ...
    <div class="table-responsive"><table class="table app-table align-middle mb-0"><thead><tr><th>User</th><th>Role</th><th>Status</th><th>Joined</th><th class="text-end">Actions</th></tr></thead><tbody>
        <?php foreach ($users as $user): ?><tr>
            ...
            <td><span class="status-pill <?= $user["role"] === "Student" ? "status-completed" : "status-active" ?>"><?= View::e($user["role"]) ?></span></td>
            ...
            <td><div class="table-actions justify-content-end">
                <?php if ($user["role"] === "Student" || ($user["role"] === "Admin" && $canManageAdministrators)): ?>
