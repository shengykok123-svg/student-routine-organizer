...
$isImage =
    $attachment && str_starts_with((string) $attachment["mime_type"], "image/");
?>
    ...
    <div>
        <div class="detail-meta">
            <span>
                ...
                <?= View::e(
                    date("d M Y", strtotime($record["exercise_date"])),
                ) ?>
            </span>
            <span>
                <i class="bi bi-clock">
                </i>
                <?= (int) $record["duration_minutes"] ?> minutes</span>
                <span>
                    <i class="bi bi-fire">
                    </i>
                    <?= number_format(
                ...
                <h1>
                    <?= View::e($record["activity_type"]) ?>
                </h1>
                <p>Your recorded workout details.</p>
                </div>
                <div class="detail-actions">
                    <a class="btn btn-light" href="<?= View::e(
                        $baseUrl,
                    ) ?>/exercise/edit?id=<?= (int) $record["exercise_id"] ?>">
                    ...
                    <div class="row g-3">
                        <div class="col-lg-7">
                            <section class="content-card mb-3">
                                <p class="card-kicker">Workout notes</p>
                                    <h2>Notes</h2>
                                        <p class="mb-0">
                                            <?= nl2br(
                                                View::e(
                                                    $record["notes"] ?:
                                                    "No notes added for this exercise.",
                                                ),
                                            ) ?>
                                        </p>
                                    </section>
                                        ...
                                        <p class="card-kicker">File</p>
                                            <h2>Workout file</h2>
                                                ...
                                                <a href="<?= View::e(
                                                    ...
                                                    <img class="diary-entry-image rounded mb-3" src="<?= View::e(
                                                        $baseUrl,
                                                    ) ?>/uploads/exercise-evidence/<?= View::e(
                                                        $attachment["stored_name"],
                                                    ) ?>" alt="Exercise file">
                                                ...
                                                <form method="post" action="<?= View::e(
                                                    $baseUrl,
                                                ) ?>/exercise/attachment/delete" class="mb-3">
                                                    <input type="hidden" name="_csrf" value="<?= View::e(
                                                        Csrf::token(),
                                                    ) ?>">
                                                    <input type="hidden" name="attachment_id" value="<?= (int) $attachment[
                                                        "attachment_id"
                                                    ] ?>">
