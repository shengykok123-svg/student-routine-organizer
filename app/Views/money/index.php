...
$chartData = [
    ...
    "income" => array_map(
        static fn (array $row): float => (float) $row["income"],
        $categorySummary,
    ),
    "expense" => array_map(
        static fn (array $row): float => (float) $row["expense"],
        $categorySummary,
    ),
];
$hasExpenses = array_sum($chartData["expense"]) > 0;
$hasCategoryActivity =
    array_sum($chartData["income"]) + array_sum($chartData["expense"]) > 0;
?>
<section class="page-heading">
    <div>
        <p class="page-eyebrow">Personal finance</p>
            <h1>Money Tracker</h1>
                <p class="page-subtitle">Showing <?= View::e(
                    $periodLabel,
                ) ?>. Filters update automatically.</p>
                </div>
                <div class="d-flex gap-2">
                    <a class="btn btn-outline-secondary" href="<?= View::e(
                        $baseUrl,
                    ) ?>/money/export?<?= View::e($exportQuery) ?>">
                    ...
                    <section class="stats-grid stats-grid-3">
                        ...
                        <article class="stat-card <?= $class ?>">
                            <div>
                                ...
                                <h2>RM <?= number_format((float) $value, 2) ?>
                                </h2>
                            </div>
                        ...
                        <form method="get" id="moneyFilter" class="row g-3 align-items-end">
                            <div class="col-lg-3">
                                <label class="form-label" for="search">Search</label>
                                    <input class="form-control" id="search" name="search" value="<?= View::e(
                                        $search,
                                ...
                                <div class="col-lg-3">
                                    <label class="form-label" for="range">Period</label>
                                        <select class="form-select" id="range" name="range">
                                            ...
                                            "month"
                                                ? "selected"
                                                : "" ?>>Recent 1 Month</option>
                                                <option value="quarter" <?= $range ===
                                                "quarter"
                                                    ? "selected"
                                                    : "" ?>>Recent 3 Months</option>
                                                    <option value="all" <?= $range ===
                                                    "all"
                                                        ? "selected"
                                                        : "" ?>>All Time</option>
...
$filterCategory
    ...
    : "" ?>>
                                                                            ...
                                                                            <div class="col-12 row g-3 <?= $range ===
                                                                            "custom"
                                                                                ? ""
                                                                                : "d-none" ?>" id="customDateRange">
                                                                                <div class="col-md-3">
                                                                                    <input class="form-control" id="start_date" type="date" name="start_date" value="<?= View::e(
                                                                                        $customStart,
                                                                                    ) ?>">
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <input class="form-control" id="end_date" type="date" name="end_date" value="<?= View::e(
                                                                                        $customEnd,
                                                                                    ) ?>">
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <section class="row g-3 mb-3" id="moneyCharts" data-chart="<?= View::e(
                                                                        json_encode(
                                                                            $chartData,
                                                                            JSON_HEX_APOS |
                                                                                JSON_HEX_AMP |
                                                                            ...
                                                                            <article class="content-card chart-card money-chart-card h-100">
                                                                                <p class="card-kicker">Expense analysis</p>
                                                                                    <h2>Spending by Category</h2>
                                                                                        ...
                                                                                        <div class="money-chart-area">
                                                                                            <canvas id="moneyCategoryChart" aria-label="Expense distribution by category">
                                                                                            </canvas>
                                                                                        </div>
                                                                                        <?php else: ?>
                                                                                        <div class="money-chart-empty">
                                                                                        ...
                                                                                        <article class="content-card chart-card money-chart-card h-100">
                                                                                            <p class="card-kicker">Category comparison</p>
                                                                                                <h2>Income vs Expenses</h2>
                                                                                                    ...
                                                                                                    <div class="money-chart-area">
                                                                                                        <canvas id="moneyComparisonChart" aria-label="Income and expense comparison by category">
                                                                                                        </canvas>
                                                                                                    </div>
                                                                                                    <?php else: ?>
                                                                                                    <div class="money-chart-empty">
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td>
                                                                                                                                                ...
                                                                                                                                                <a class="btn btn-sm btn-outline-secondary" href="<?= View::e(
                                                                                                                                                    $baseUrl,
                                                                                                                                                ) ?>/money/receipt?id=<?= (int) $record[
    "record_id"
] ?>" target="_blank" rel="noopener" title="View receipt">
    ...
    "record_id"
                                                                                                                                                        ...
                                                                                                                                                        <form method="post" action="<?= View::e(
                                                                                                                                                            $baseUrl,
                                                                                                                                                        ) ?>/money/delete" onsubmit="return confirm('Delete this transaction?')">
                                                                                                                                                            ...
                                                                                                                                                            <button class="btn btn-sm btn-outline-danger" title="Delete transaction">
                                                                                                                                                ...
                                                                                                                                                <td colspan="7">
                                                                                                                                                    <div class="empty-state">
                                                                                                                                                        <h3>No transactions found</h3>
                                                                                                                                                            <p>Try another filter or add a transaction.</p>
                                                                                                                                                            </div>
                                                                                                                                                        </td>
                                                                                                                                                    </tr>
                                                                                                                                                    <?php endif; ?>
