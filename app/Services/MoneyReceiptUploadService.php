...
/** Validates and stores transaction receipt images. */
    ...
    public function upload(array $file): ?string
    {
        ...
        if (
            ...
            throw new \RuntimeException(
                "The receipt image could not be uploaded.",
            );
        }
        if (
            (int) ($file["size"] ?? 0) < 1 ||
            ...
            throw new \RuntimeException(
                "Receipt images must be 5 MB or smaller.",
            );
        }
        ...
        if ($extension === null || @getimagesize($temporaryPath) === false) {
            throw new \RuntimeException(
                "Use a genuine JPG, PNG, or WebP receipt image.",
            );
        }
